...
$consulta  = "SELECT * FROM `bloquematerialmedico` INNER JOIN `tipomedicamento` ON `bloquematerialmedico`.`Id_Mat_Med` = `tipomedicamento`.`Id_Mat_Med` ORDER BY Fecha_caducidad ASC ";
