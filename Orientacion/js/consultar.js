...
document.getElementById("selecionar").addEventListener(
  ...
  function () {
    if (
      document.getElementById("m_boleta").innerHTML ==
      "Paciente borrado, nombre Expaciente:"
    ) {
...
document.querySelector("#form_login").addEventListener(
  ...
  function (event) {
    ...
    xml2.open("POST", "php/consultar_orientacion.php", true);
...
document.getElementById("Tipo_atencion").addEventListener(
  "change",
  function (event) {
    if (event.target.value === "5") {
      document.getElementById("text1").style.display = "block";
      document.getElementById("nombre_1").style.display = "block";
      document.getElementById("text2").style.display = "block";
      document.getElementById("TEL_1").style.display = "block";
      document.getElementById("text3").style.display = "block";
      document.getElementById("nombre_2").style.display = "block";
      document.getElementById("text4").style.display = "block";
      document.getElementById("TEL_2").style.display = "block";
      ...
      document.getElementById("TEL_2").style.display = "none";
