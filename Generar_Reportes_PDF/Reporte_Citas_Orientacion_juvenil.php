...
$npacientes_12345="SELECT count(motivo) FROM `orientación_juvenil` WHERE motivo = '12345' AND `dia` <= '". $fecha_final ."' AND `dia` >= '". $fecha_inicial ."'";
...
$n_m1 = "SELECT count(motivo) FROM `orientación_juvenil` WHERE motivo = '1' AND `dia` <= '". $fecha_final ."' AND `dia` >= '". $fecha_inicial ."'" ;
$motivo1 = "SELECT *FROM `orientación_juvenil` WHERE motivo = '1' AND `dia` <= '". $fecha_final ."' AND `dia` >= '". $fecha_inicial ."'";

$n_m2 = "SELECT count(motivo) FROM `orientación_juvenil` WHERE motivo = '2' AND `dia` <= '". $fecha_final ."' AND `dia` >= '". $fecha_inicial ."'" ;
$motivo2 = "SELECT *FROM `orientación_juvenil` WHERE motivo = '2' AND `dia` <= '". $fecha_final ."' AND `dia` >= '". $fecha_inicial ."'";

$n_m3 = "SELECT count(motivo) FROM `orientación_juvenil` WHERE motivo = '3' AND `dia` <= '". $fecha_final ."' AND `dia` >= '". $fecha_inicial ."'" ;
$motivo3 = "SELECT *FROM `orientación_juvenil` WHERE motivo = '3' AND `dia` <= '". $fecha_final ."' AND `dia` >= '". $fecha_inicial ."'";

// $n_m4 = "SELECT count(motivo) FROM `orientación_juvenil` WHERE motivo = '4' AND `dia` <= '". $fecha_final ."' AND `dia` >= '". $fecha_inicial ."'" ;
// $motivo4 = "SELECT *FROM `orientación_juvenil` WHERE motivo = '4' AND `dia` <= '". $fecha_final ."' AND `dia` >= '". $fecha_inicial ."'";
...
$n_citas = mysqli_query($link, $n_consultados_orientacion_juvenil) or die("Error al ejecutar la consulta de cantidad de citas totales");
...
$PDF->Cell(70, 10, utf8_decode('Consulta individual'), 1, 0, 'C', 0);//tipo1
$PDF->SetFont('Arial', '', 12);
$PDF->Cell(25, 10, implode($rows_n_motivo1[0]), 1, 1, 'C', 0);

$PDF->SetFont('Arial', 'B', 9.4);
$PDF->Cell(70, 10, utf8_decode('Atención a padres de familiar '), 1, 0, 'C', 0);//tipo2
$PDF->SetFont('Arial', '', 12);
...
$PDF->Cell(94, 10, utf8_decode('Lista de citas por consulta individual '), 0, 1, 'C', 0);
$PDF->SetFont('Arial', 'B', 12);
...
$PDF->SetFont('Arial', 'B', 15);
$PDF->Cell(118, 10, utf8_decode('Lista de citas por atención a padres de familia '), 0, 1, 'C', 0);
$PDF->SetFont('Arial', 'B', 12);
$PDF->Cell(55, 10, 'Boleta / Num. trabajador', 1, 0, 'C', 0);
$PDF->SetFont('Arial', 'B', 15);
$PDF->Cell(60, 10, 'Nombre', 1, 0, 'C', 0);
