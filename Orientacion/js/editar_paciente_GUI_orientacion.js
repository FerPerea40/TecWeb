...
document.getElementById("boleta").addEventListener(
  ...
  function (event) {
    ...
    var mensaje3 = document.getElementById("m3_boleta");
    var xml;
    ...
    xml.onreadystatechange = function () {
      if (this.readyState == 4 && this.status == 200) {
        ...
        if(respuesta.borrar==1){
          ...
          mensaje3.innerHTML = "Al editar la información de este paciente se recuperara su información y se eliminara el borrado lógico";
