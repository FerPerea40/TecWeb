...
$npacientes_12345="SELECT count(motivo) FROM `extension_y_apoyos` WHERE motivo = '12345' AND `dia` <= '". $fecha_final ."' AND `dia` >= '". $fecha_inicial ."'";

//orientacion juvenil
//$n_consultados_orientacion_juvenil= "SELECT count(id) FROM `extension_y_apoyos` WHERE `dia` <= '". $fecha_final ."' AND `dia` >= '". $fecha_inicial ."'";
...
$n_m1 = "SELECT count(motivo) FROM `extension_y_apoyos` WHERE motivo = '1' AND `dia` <= '". $fecha_final ."' AND `dia` >= '". $fecha_inicial ."'" ;
$motivo1 = "SELECT *FROM `extension_y_apoyos` WHERE motivo = '1' AND `dia` <= '". $fecha_final ."' AND `dia` >= '". $fecha_inicial ."'";

$n_m2 = "SELECT count(motivo) FROM `extension_y_apoyos` WHERE motivo = '2' AND `dia` <= '". $fecha_final ."' AND `dia` >= '". $fecha_inicial ."'" ;
$motivo2 = "SELECT *FROM `extension_y_apoyos` WHERE motivo = '2' AND `dia` <= '". $fecha_final ."' AND `dia` >= '". $fecha_inicial ."'";

$n_m3 = "SELECT count(motivo) FROM `extension_y_apoyos` WHERE motivo = '3' AND `dia` <= '". $fecha_final ."' AND `dia` >= '". $fecha_inicial ."'" ;
$motivo3 = "SELECT *FROM `extension_y_apoyos` WHERE motivo = '3' AND `dia` <= '". $fecha_final ."' AND `dia` >= '". $fecha_inicial ."'";

$n_m4 = "SELECT count(motivo) FROM `extension_y_apoyos` WHERE motivo = '4' AND `dia` <= '". $fecha_final ."' AND `dia` >= '". $fecha_inicial ."'" ;
$motivo4 = "SELECT *FROM `extension_y_apoyos` WHERE motivo = '4' AND `dia` <= '". $fecha_final ."' AND `dia` >= '". $fecha_inicial ."'";

$n_m5 = "SELECT count(motivo) FROM `extension_y_apoyos` WHERE motivo = '5' AND `dia` <= '". $fecha_final ."' AND `dia` >= '". $fecha_inicial ."'" ;
$motivo5 = "SELECT *FROM `extension_y_apoyos` WHERE motivo = '5' AND `dia` <= '". $fecha_final ."' AND `dia` >= '". $fecha_inicial ."'";

$n_m6 = "SELECT count(motivo) FROM `extension_y_apoyos` WHERE motivo = '6' AND `dia` <= '". $fecha_final ."' AND `dia` >= '". $fecha_inicial ."'" ;
$motivo6 = "SELECT *FROM `extension_y_apoyos` WHERE motivo = '5' AND `dia` <= '". $fecha_final ."' AND `dia` >= '". $fecha_inicial ."'";


$n_citas = mysqli_query($link, $n_consultados_extension_apoy) or die("Error al ejecutar la consulta de cantidad de citas totales");
...
$PDF->Cell(70, 10, utf8_decode('Becas'), 1, 0, 'C', 0);//tipo1
$PDF->SetFont('Arial', '', 12);
$PDF->Cell(25, 10, implode($rows_n_motivo1[0]), 1, 1, 'C', 0);

$PDF->SetFont('Arial', 'B', 9.4);
$PDF->Cell(70, 10, utf8_decode('Servicio social'), 1, 0, 'C', 0);//tipo2
$PDF->SetFont('Arial', '', 12);
$PDF->Cell(25, 10, implode($rows_n_motivo2[0]), 1, 1, 'C', 0);

$PDF->SetFont('Arial', 'B', 9.4);
$PDF->Cell(70, 10, utf8_decode('Movilidad'), 1, 0, 'C', 0);//tipo3
$PDF->SetFont('Arial', '', 12);
$PDF->Cell(25, 10, implode($rows_n_motivo3[0]), 1, 1, 'C', 0);

$PDF->SetFont('Arial', 'B', 9.4);
$PDF->Cell(70, 10, utf8_decode('Cultura'), 1, 0, 'C', 0);//tipo4 
$PDF->SetFont('Arial', '', 12);
$PDF->Cell(25, 10, implode($rows_n_motivo4[0]), 1, 1, 'C', 0);

$PDF->SetFont('Arial', 'B', 9.4);
$PDF->Cell(70, 10, utf8_decode('Deportes'), 1, 0, 'C', 0);//tipo5
$PDF->SetFont('Arial', '', 12);
...
$PDF->Cell(59, 10, utf8_decode('Lista de citas de becas '), 0, 1, 'C', 0);
$PDF->SetFont('Arial', 'B', 12);
...
$PDF->SetFont('Arial', 'B', 15);
$PDF->Cell(80, 10, utf8_decode('Lista de citas de servicio social '), 0, 1, 'C', 0);
$PDF->SetFont('Arial', 'B', 12);
$PDF->Cell(55, 10, 'Boleta / Num. trabajador', 1, 0, 'C', 0);
$PDF->SetFont('Arial', 'B', 15);
$PDF->Cell(60, 10, 'Nombre', 1, 0, 'C', 0);
...
$PDF->SetFont('Arial', 'B', 15);
$PDF->Cell(68, 10, utf8_decode('Lista de citas de movilidad '), 0, 1, 'C', 0);
$PDF->SetFont('Arial', 'B', 12);
$PDF->Cell(55, 10, 'Boleta / Num. trabajador', 1, 0, 'C', 0);
$PDF->SetFont('Arial', 'B', 15);
$PDF->Cell(60, 10, 'Nombre', 1, 0, 'C', 0);
...
$PDF->SetFont('Arial', 'B', 15);
$PDF->Cell(60, 10, utf8_decode('Lista de citas de cultura '), 0, 1, 'C', 0);
$PDF->SetFont('Arial', 'B', 12);
$PDF->Cell(55, 10, 'Boleta / Num. trabajador', 1, 0, 'C', 0);
$PDF->SetFont('Arial', 'B', 15);
$PDF->Cell(60, 10, 'Nombre', 1, 0, 'C', 0);
...
$PDF->SetFont('Arial', 'B', 15);
$PDF->Cell(67, 10, utf8_decode('Lista de citas de deportes '), 0, 1, 'C', 0);
$PDF->SetFont('Arial', 'B', 12);
$PDF->Cell(55, 10, 'Boleta / Num. trabajador', 1, 0, 'C', 0);
$PDF->SetFont('Arial', 'B', 15);
$PDF->Cell(60, 10, 'Nombre', 1, 0, 'C', 0);
