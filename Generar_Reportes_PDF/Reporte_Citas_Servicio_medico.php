...
//extension y apoyos 
// $n_consultados_extension_apoy= "SELECT count(id) FROM `servicio_medico` WHERE `dia` <= '". $fecha_final ."' AND `dia` >= '". $fecha_inicial ."'";

//orientacion juvenil
//$n_consultados_orientacion_juvenil= "SELECT count(id) FROM `servicio_medico` WHERE `dia` <= '". $fecha_final ."' AND `dia` >= '". $fecha_inicial ."'";
...
$npacientes_12345="SELECT count(motivo) FROM `servicio_medico` WHERE motivo = '12345' AND `dia` <= '". $fecha_final ."' AND `dia` >= '". $fecha_inicial ."'";
...
$n_m1 = "SELECT count(motivo) FROM `servicio_medico` WHERE motivo = '1' AND `dia` <= '". $fecha_final ."' AND `dia` >= '". $fecha_inicial ."'" ;
$motivo1 = "SELECT *FROM `servicio_medico` WHERE motivo = '1' AND `dia` <= '". $fecha_final ."' AND `dia` >= '". $fecha_inicial ."'";

$n_m2 = "SELECT count(motivo) FROM `servicio_medico` WHERE motivo = '2' AND `dia` <= '". $fecha_final ."' AND `dia` >= '". $fecha_inicial ."'" ;
$motivo2 = "SELECT *FROM `servicio_medico` WHERE motivo = '2' AND `dia` <= '". $fecha_final ."' AND `dia` >= '". $fecha_inicial ."'";

$n_m3 = "SELECT count(motivo) FROM `servicio_medico` WHERE motivo = '3' AND `dia` <= '". $fecha_final ."' AND `dia` >= '". $fecha_inicial ."'" ;
$motivo3 = "SELECT *FROM `servicio_medico` WHERE motivo = '3' AND `dia` <= '". $fecha_final ."' AND `dia` >= '". $fecha_inicial ."'";

$n_m4 = "SELECT count(motivo) FROM `servicio_medico` WHERE motivo = '4' AND `dia` <= '". $fecha_final ."' AND `dia` >= '". $fecha_inicial ."'" ;
$motivo4 = "SELECT *FROM `servicio_medico` WHERE motivo = '4' AND `dia` <= '". $fecha_final ."' AND `dia` >= '". $fecha_inicial ."'";

$n_m5 = "SELECT count(motivo) FROM `servicio_medico` WHERE motivo = '5' AND `dia` <= '". $fecha_final ."' AND `dia` >= '". $fecha_inicial ."'" ;
$motivo5 = "SELECT *FROM `servicio_medico` WHERE motivo = '5' AND `dia` <= '". $fecha_final ."' AND `dia` >= '". $fecha_inicial ."'";

$n_m6 = "SELECT count(motivo) FROM `servicio_medico` WHERE motivo = '6' AND `dia` <= '". $fecha_final ."' AND `dia` >= '". $fecha_inicial ."'" ;
$motivo6 = "SELECT *FROM `servicio_medico` WHERE motivo = '5' AND `dia` <= '". $fecha_final ."' AND `dia` >= '". $fecha_inicial ."'";


$n_citas = mysqli_query($link, $n_consultados_servicio_medico) or die("Error al ejecutar la consulta de cantidad de citas totales");
...
$PDF->Cell(70, 10, utf8_decode('Servicio de información de altas y bajas'), 1, 0, 'C', 0);//tipo1
$PDF->SetFont('Arial', '', 12);
$PDF->Cell(25, 10, implode($rows_n_motivo1[0]), 1, 1, 'C', 0);

$PDF->SetFont('Arial', 'B', 9.4);
$PDF->Cell(70, 10, utf8_decode('Vigencias'), 1, 0, 'C', 0);//tipo2
$PDF->SetFont('Arial', '', 12);
$PDF->Cell(25, 10, implode($rows_n_motivo2[0]), 1, 1, 'C', 0);

$PDF->SetFont('Arial', 'B', 9.4);
$PDF->Cell(70, 10, utf8_decode('Seguros de vida'), 1, 0, 'C', 0);//tipo3
$PDF->SetFont('Arial', '', 12);
$PDF->Cell(25, 10, implode($rows_n_motivo3[0]), 1, 1, 'C', 0);

$PDF->SetFont('Arial', 'B', 9.4);
$PDF->Cell(70, 10, utf8_decode('Área de lactancia'), 1, 0, 'C', 0);//tipo4 
$PDF->SetFont('Arial', '', 12);
$PDF->Cell(25, 10, implode($rows_n_motivo4[0]), 1, 1, 'C', 0);

$PDF->SetFont('Arial', 'B', 9.4);
$PDF->Cell(70, 10, utf8_decode('Consulta médica'), 1, 0, 'C', 0);//tipo5
$PDF->SetFont('Arial', '', 12);
$PDF->Cell(25, 10, implode($rows_n_motivo5[0]), 1, 1, 'C', 0);

$PDF->SetFont('Arial', 'B', 9.4);
$PDF->Cell(70, 10, utf8_decode('Otro'), 1, 0, 'C', 0);//tipo6
$PDF->SetFont('Arial', '', 12);
...
$PDF->Cell(144, 10, utf8_decode('Lista de citas de servicio de información de altas y bajas '), 0, 1, 'C', 0);
$PDF->SetFont('Arial', 'B', 12);
...
$PDF->SetFont('Arial', 'B', 15);
$PDF->Cell(67, 10, utf8_decode('Lista de citas de vigencias '), 0, 1, 'C', 0);
$PDF->SetFont('Arial', 'B', 12);
$PDF->Cell(55, 10, 'Boleta / Num. trabajador', 1, 0, 'C', 0);
$PDF->SetFont('Arial', 'B', 15);
$PDF->Cell(60, 10, 'Nombre', 1, 0, 'C', 0);
...
$PDF->SetFont('Arial', 'B', 15);
$PDF->Cell(82, 10, utf8_decode('Lista de citas de seguros de vida'), 0, 1, 'C', 0);
$PDF->SetFont('Arial', 'B', 12);
$PDF->Cell(55, 10, 'Boleta / Num. trabajador', 1, 0, 'C', 0);
$PDF->SetFont('Arial', 'B', 15);
$PDF->Cell(60, 10, 'Nombre', 1, 0, 'C', 0);
...
$PDF->SetFont('Arial', 'B', 15);
$PDF->Cell(86, 10, utf8_decode('Lista de citas de área de lactancia '), 0, 1, 'C', 0);
$PDF->SetFont('Arial', 'B', 12);
$PDF->Cell(55, 10, 'Boleta / Num. trabajador', 1, 0, 'C', 0);
$PDF->SetFont('Arial', 'B', 15);
$PDF->Cell(60, 10, 'Nombre', 1, 0, 'C', 0);
...
$PDF->SetFont('Arial', 'B', 15);
$PDF->Cell(85, 10, utf8_decode('Lista de citas de consulta médica '), 0, 1, 'C', 0);
$PDF->SetFont('Arial', 'B', 12);
$PDF->Cell(55, 10, 'Boleta / Num. trabajador', 1, 0, 'C', 0);
$PDF->SetFont('Arial', 'B', 15);
$PDF->Cell(60, 10, 'Nombre', 1, 0, 'C', 0);
