...
//orientacion juvenil
//$n_consultados_orientacion_juvenil= "SELECT count(id) FROM `orientación_juvenil` WHERE `dia` <= '". $fecha_final ."' AND `dia` >= '". $fecha_inicial ."'";

//servicios estudiantiles
$n_consultados_servicio_estud= "SELECT count(id) FROM `servicios_estudiantiles` WHERE `dia` <= '". $fecha_final ."' AND `dia` >= '". $fecha_inicial ."'";
$npacientes_12345="SELECT count(motivo) FROM `servicios_estudiantiles` WHERE motivo = '12345' AND `dia` <= '". $fecha_final ."' AND `dia` >= '". $fecha_inicial ."'";
...
$n_m1 = "SELECT count(motivo) FROM `servicios_estudiantiles` WHERE motivo = '1' AND `dia` <= '". $fecha_final ."' AND `dia` >= '". $fecha_inicial ."'" ;
$motivo1 = "SELECT *FROM `servicios_estudiantiles` WHERE motivo = '1' AND `dia` <= '". $fecha_final ."' AND `dia` >= '". $fecha_inicial ."'";

$n_m2 = "SELECT count(motivo) FROM `servicios_estudiantiles` WHERE motivo = '2' AND `dia` <= '". $fecha_final ."' AND `dia` >= '". $fecha_inicial ."'" ;
$motivo2 = "SELECT *FROM `servicios_estudiantiles` WHERE motivo = '2' AND `dia` <= '". $fecha_final ."' AND `dia` >= '". $fecha_inicial ."'";

$n_m3 = "SELECT count(motivo) FROM `servicios_estudiantiles` WHERE motivo = '3' AND `dia` <= '". $fecha_final ."' AND `dia` >= '". $fecha_inicial ."'" ;
$motivo3 = "SELECT *FROM `servicios_estudiantiles` WHERE motivo = '3' AND `dia` <= '". $fecha_final ."' AND `dia` >= '". $fecha_inicial ."'";

$n_m4 = "SELECT count(motivo) FROM `servicios_estudiantiles` WHERE motivo = '4' AND `dia` <= '". $fecha_final ."' AND `dia` >= '". $fecha_inicial ."'" ;
$motivo4 = "SELECT *FROM `servicios_estudiantiles` WHERE motivo = '4' AND `dia` <= '". $fecha_final ."' AND `dia` >= '". $fecha_inicial ."'";

// $n_m5 = "SELECT count(motivo) FROM `orientación_juvenil` WHERE motivo = '5' AND `dia` <= '". $fecha_final ."' AND `dia` >= '". $fecha_inicial ."'" ;
// $motivo5 = "SELECT *FROM `orientación_juvenil` WHERE motivo = '5' AND `dia` <= '". $fecha_final ."' AND `dia` >= '". $fecha_inicial ."'";


$n_citas = mysqli_query($link, $n_consultados_servicio_estud) or die("Error al ejecutar la consulta de cantidad de citas totales");
...
$PDF->Cell(100, 10, utf8_decode('Recoger carta de no adeudo de libro '), 1, 0, 'C', 0);//tipo1
$PDF->SetFont('Arial', '', 12);
$PDF->Cell(25, 10, implode($rows_n_motivo1[0]), 1, 1, 'C', 0);

$PDF->SetFont('Arial', 'B', 9.4);
$PDF->Cell(100, 10, utf8_decode('Recoger oficio de entrega de material bibliográfico'), 1, 0, 'C', 0);//tipo2
$PDF->SetFont('Arial', '', 12);
$PDF->Cell(25, 10, implode($rows_n_motivo2[0]), 1, 1, 'C', 0);

$PDF->SetFont('Arial', 'B', 9.4);
$PDF->Cell(100, 10, utf8_decode('Recoger oficio de entrega de tésis o trabajo terminal'), 1, 0, 'C', 0);//tipo3
$PDF->SetFont('Arial', '', 12);
$PDF->Cell(25, 10, implode($rows_n_motivo3[0]), 1, 1, 'C', 0);

$PDF->SetFont('Arial', 'B', 9.4);
$PDF->Cell(100, 10, utf8_decode('Otro'), 1, 0, 'C', 0);//tipo4 
$PDF->SetFont('Arial', '', 12);
...
$PDF->Cell(133, 10, utf8_decode('Lista de citas de recoger carta de no adeudo de libro '), 0, 1, 'C', 0);
$PDF->SetFont('Arial', 'B', 12);
...
$PDF->SetFont('Arial', 'B', 15);
$PDF->Cell(169, 10, utf8_decode('Lista de citas de recoger oficio de entrega de material bibliográfico '), 0, 1, 'C', 0);
$PDF->SetFont('Arial', 'B', 12);
$PDF->Cell(55, 10, 'Boleta / Num. trabajador', 1, 0, 'C', 0);
$PDF->SetFont('Arial', 'B', 15);
$PDF->Cell(60, 10, 'Nombre', 1, 0, 'C', 0);
...
$PDF->SetFont('Arial', 'B', 15);
$PDF->Cell(172, 10, utf8_decode('Lista de citas de recoger oficio de entrega de tésis o trabajo terminal'), 0, 1, 'C', 0);
$PDF->SetFont('Arial', 'B', 12);
$PDF->Cell(55, 10, 'Boleta / Num. trabajador', 1, 0, 'C', 0);
$PDF->SetFont('Arial', 'B', 15);
$PDF->Cell(60, 10, 'Nombre', 1, 0, 'C', 0);
